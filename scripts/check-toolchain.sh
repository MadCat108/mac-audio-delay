...
echo >&2
echo "To repair it:" >&2
echo "  1. Open System Settings → General → Software Update." >&2
echo "  2. Install every available macOS and Command Line Tools update." >&2
echo "  3. Restart the Mac, then run the Audio Delay installer again." >&2
echo >&2
